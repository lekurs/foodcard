...
{{--        const cardButton = document.getElementById('submitButton');--}}

{{--        cardElement.mount('#card-element');--}}

{{--        cardButton.addEventListener('click', async (e) => {--}}
{{--            const { setupIntent, errorCard } = await stripe.confirmCardSetup(--}}
{{--                clientSecret, {--}}
{{--                    payment_method: {--}}
{{--                        card: cardElement,--}}
...
{{--            const { paymentMethod, errorPayment } = await stripe.createPaymentMethod(--}}
{{--                'card', cardElement, {--}}
{{--                    billing_details: { name: cardHolderName.value }--}}
{{--                }--}}
{{--            );--}}

{{--            if (errorPayment || errorCard) {--}}
{{--                // Display "error.message" to the user...--}}
{{--                console.log(errorPayment || errorCard)--}}
{{--            } else {--}}
{{--                // The card has been verified successfully...--}}
{{--                console.log('pffff, voilà !')--}}
{{--            }--}}
{{--        });--}}
{{--    </script>--}}
